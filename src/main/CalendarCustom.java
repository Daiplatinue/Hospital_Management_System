...
public class CalendarCustom extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1.add(lbTime, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, 207, 69));

        lbType.setFont(new java.awt.Font("sansserif", 1, 25)); // NOI18N
        lbType.setText("PM");
        jPanel1.add(lbType, new org.netbeans.lib.awtextra.AbsoluteConstraints(223, 37, 52, -1));

        lbDate.setFont(new java.awt.Font("sansserif", 0, 18)); // NOI18N
        lbDate.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbDate.setText("Sunday, 30/05/2021");
        jPanel1.add(lbDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 86, 265, -1));
