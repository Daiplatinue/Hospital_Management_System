...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 25, 2024 at 09:30 PM
...
--
ALTER TABLE `a_logs`
  MODIFY `a_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
--
ALTER TABLE `donations`
  MODIFY `ds_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
